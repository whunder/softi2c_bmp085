...
SoftI2C_BMP085::SoftI2C_BMP085() {
}


boolean SoftI2C_BMP085::begin(uint8_t mode) {
...
int32_t SoftI2C_BMP085::computeB5(int32_t UT) {
  int32_t X1 = (UT - (int32_t)ac6) * ((int32_t)ac5) >> 15;
  int32_t X2 = ((int32_t)mc << 11) / (X1+(int32_t)md);
  return X1 + X2;
}

uint16_t SoftI2C_BMP085::readRawTemperature(void) {
...
uint32_t SoftI2C_BMP085::readRawPressure(void) {
  uint32_t raw;
...
int32_t SoftI2C_BMP085::readPressure(void) {
...
int32_t SoftI2C_BMP085::readSealevelPressure(float altitude_meters) {
  float pressure = readPressure();
  return (int32_t)(pressure / pow(1.0-altitude_meters/44330, 5.255));
}

float SoftI2C_BMP085::readTemperature(void) {
...
float SoftI2C_BMP085::readAltitude(float sealevelPressure) {
  float altitude;
...
uint8_t SoftI2C_BMP085::read8(uint8_t a) {
  uint8_t ret;
...
uint16_t SoftI2C_BMP085::read16(uint8_t a) {
  uint16_t ret;
...
void SoftI2C_BMP085::write8(uint8_t a, uint8_t d) {
  i2c_start(BMP085_I2CADDR | I2C_WRITE);
  i2c_write(a);
  i2c_write(d);
  i2c_stop();
